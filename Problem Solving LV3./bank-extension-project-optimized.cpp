...
void PrintClientRecordBalanceLine(stClient DataClient)
{
    cout << "| " << left << setw(15) << DataClient.AccountNumber;
    cout << "| " << left << setw(40) << DataClient.Name;
    cout << "| " << left << setw(12) << DataClient.AccountBalance;
...
void DepositBalanceToClientByAccountNumber(string AccountNumber, double Amount, vector <stClient> vDataClients)
{
...
void ShowDepositScreen()
{
    ...
    while (!FindClientByAccountNumber(AccountNumber, Client, vDataClients))
    {
    ...
    DepositBalanceToClientByAccountNumber(AccountNumber, Amount, vDataClients);
}
...
void ShowWithdrawScreen()
{
    ...
    DepositBalanceToClientByAccountNumber(AccountNumber, Amount * -1, vDataClients);
}
...
void ShowTotalBalances()
{
    ...
    cout << "\n\t\t\t\t\tBalances List (" << vDataClients.size() << ") Client(s).";
    cout << "\n-------------------------------------------------------";
    cout << "--------------------------------------------------\n";
    cout << "| " << left << setw(15) << "Account Number";
    cout << "| " << left << setw(40) << "Client Name";
    ...
    { 
        for (stClient& DataClient : vDataClients)
        {
            PrintClientRecordBalanceLine(DataClient);
            TotalBalances += DataClient.AccountBalance;
            cout << endl;
        }
    }
